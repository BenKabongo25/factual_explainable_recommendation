...
def load_dataset(data_dir, split, val_ratio, test_ratio, stage):
    '''
    Parameters
    ----------
    dataset_dir : string
    ...
    '''
    graph_saving_path = os.path.join(data_dir, f'{split}_graph.bin')
    ...
    if stage == 'step1':
        ...
        # Update processed_g tuple
        processed_g = (*processed_g[:5], test_pos_g, processed_g[6])
        return g, processed_g
