...
parser.add_argument('--sample_neg_edges', default=False, action=argparse.BooleanOptionalAction,
...
if args.save_model:
    output_dir = Path.cwd().joinpath(args.output_dir)
    if not os.path.exists(output_dir):
        os.makedirs(output_dir)
    torch.save(model.state_dict(), output_dir.joinpath(f"gnn_{args.split}.pth"))
