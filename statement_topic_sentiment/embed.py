...
def main(config):
    sts_df_path = os.path.join(config.dataset_dir, "statement_topic_sentiment_freq.csv")
    ...
    embeddings_dir = os.path.join(config.dataset_dir, "vectors", config.model_name)
